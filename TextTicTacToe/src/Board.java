                ...
                try {
                    if (!textField.getText().equalsIgnoreCase(turn)) {
                        if (textField.isFocusOwner()) {
                            textField.setText("");
                        } // if the text entered does not match turn then the textfield with the cursor is
                          // emptied

                        alternateTurns();
                        // alternates turns so a player who dosent put in the correct input won't lose
                        // their turn
                    } else {
                        textField.setEditable(false);
                    } // after text is entered that matches the current turn the textfield is set to
                      // uneditable
